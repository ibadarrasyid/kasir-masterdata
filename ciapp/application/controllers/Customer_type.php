...
class Customer_type extends G_Controller {
    ...
    public function __construct() {
        ...
        $this->url_controller = base_url('customer_type');
        $this->table_use = 'm_customer_type';

        $this->load->model('M_customer_type', 'm');
    }

    public function index() {
        $data['url_controller'] = $this->url_controller;

        $content = $this->load->view("page/p_customer_type", $data, TRUE);
    ...
    public function form() {
        ...
        $this->load->view("form/f_customer_type", $data);
    }
    ...
    public function save() {
        ...
        if ($this->input->post('nama') != $this->input->post('nama_old')) {
            $is_unique_nama =  '|is_unique[m_customer_type.nama]';
        } else {
            $is_unique_nama =  '';
        }

        $this->load->library('form_validation');
        $this->form_validation->set_rules('nama', 'Nama', 'trim|required|strtolower'.$is_unique_nama);
        $this->set_formMsg();
    ...
    public function delete() {
        ...
        delete_customer_type_divison('customer_type', $id);
