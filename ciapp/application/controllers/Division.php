...
class Division extends G_Controller {
    ...
    public function __construct() {
        ...
        $this->url_controller = base_url('division');
        $this->table_use = 'm_division';

        $this->load->model('M_division', 'm');
    }

    public function index() {
        $data['url_controller'] = $this->url_controller;

        $content = $this->load->view("page/p_division", $data, TRUE);
    ...
    public function form() {
        ...
        $this->load->view("form/f_division", $data);
    }
    ...
    public function delete() {
        ...
        delete_customer_type_divison('division', $id);
    ...
    public function get_data() {
        ...
        $data = $this->Master_m->get("m_category", ['id_division' => $id]);
        echo json_encode([
            'status' => true,
