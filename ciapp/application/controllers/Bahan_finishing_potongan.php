<?php
class Bahan_finishing_potongan extends G_Controller {
    ...
    public function __construct() {
        ...
        $this->url_controller = base_url('bahan_finishing_potongan');

        $this->load->model('M_bahan_finishing_potongan', 'm');
    }
    ...
    public function index() {
        ...
        $content = $this->load->view("page/p_bahan_finishing_potongan", $data, TRUE);
    ...
    public function form() {
        ...
        $this->load->view("form/f_bahan_finishing_potongan", $data);
    }
    ...
    public function save() {
        ...
        $this->form_validation->set_rules('id_finishing', 'Bahan', 'required');
