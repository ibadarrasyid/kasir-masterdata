    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-info">
                <h2 class="mb-0">Potongan Harga Bahan Finishing</h2>
                <p class="mb-0">Menu untuk menagement potongan harga pada bahan finishing</p>
            </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="mb-0">Form Potongan Harga Bahan Finishing</h4>
