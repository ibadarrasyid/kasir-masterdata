<?php
$id_form = 'form-potongan-bahan-finishing';
?>
    ...
    <div class="row clearfix">
        <div class="col-sm-12">
            ...
            <div class="form-group">
                <div class="form-line">
                    <label for="">Bahan Finishing</label>
                    <select class="form-control form-control-sm" name="id_finishing">
                        <option value="">- Pilih Bahan Finishing -</option>
                        <?php 
                        $list_bahan_finishing = $this->m->get_list_bahan_finishing();
                        foreach ($list_bahan_finishing as $v_bahan_finishing) {
                            $selected_bahan = $v_bahan_finishing->id == $data['id_finishing'] ? 'selected' : '';
                            ?>
                                <option value="<?= $v_bahan_finishing->id ?>" <?= $selected_bahan ?>><?=  $v_bahan_finishing->nama ?></option>
                            <?php
                        }
                        ?>
                    </select>
